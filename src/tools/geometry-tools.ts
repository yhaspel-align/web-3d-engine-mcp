...
export function registerGeometryTools(server: McpServer, relay: WebSocketRelay): void {
  server.registerTool(
    'remove_object',
    {
  ...
  server.registerTool(
    ...
    {
      description:
        'Create a new primitive geometry object and add it directly to the root scene. ' +
  ...
  server.registerTool(
    ...
    {
      description:
        'Create a new primitive geometry object and add it to a named group in the scene. ' +
