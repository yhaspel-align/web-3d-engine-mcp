...
export function registerStateTools(server, relay) {
    server.registerTool('get_engine_snapshot', {
        description: 'Get a full engine state snapshot including context summary, feature flags, plugin presets, render views, model loaded state, and plugin sync state.',
    ...
    server.registerTool('get_engine_context', {
    ...
    server.registerTool('get_plugin_presets', {
    ...
    server.registerTool('get_render_views', {
    ...
    server.registerTool('get_plugin_sync_state', {
    ...
    server.registerTool('get_jaw_navigation_state', {
        description: 'Get the current jaw visibility state from the JawsNavigation plugin preset. ' +
