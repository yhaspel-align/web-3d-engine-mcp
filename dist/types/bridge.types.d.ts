...
export type BridgeCommandMethod = 'get_engine_snapshot' | 'get_engine_context' | 'get_plugin_presets' | 'get_feature_flags' | 'get_render_views' | 'get_plugin_sync_state' | 'get_review_tool_state' | 'dispatch_engine_action' | 'update_engine_context' | 'update_plugin_preset' | 'call_store_action';
